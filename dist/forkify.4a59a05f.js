...
const controlRecipes = async function() {
    try {
        ...
        if (!id) {
            (0, _recipeViewsJsDefault.default).renderError('Please select a recipe');
            return;
        }
        ...
        if (!_modelJs.state.recipe || !_modelJs.state.recipe.ingredients) throw new Error('Recipe data is invalid');
        console.log('Loaded recipe:', _modelJs.state.recipe);
        // Render the recipe
        (0, _recipeViewsJsDefault.default).render(_modelJs.state.recipe);
    } catch (err) {
        console.error('Error in controlRecipes:', err);
        (0, _recipeViewsJsDefault.default).renderError(err.message);
    }
};
...
},{"core-js/modules/web.immediate.js":"bzsBv","regenerator-runtime/runtime":"f6ot0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./model.js":"3QBkH","./views/recipeViews.js":"eC0AB"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
},{"regenerator-runtime":"f6ot0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./config":"2hPh4","./helper":"b1fwP"}],"2hPh4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./config":"2hPh4"}],"eC0AB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RecipeView {
    ...
    #formatQuantity(quantity) {
        ...
        for(let denom = 1; denom <= 20; denom++)for(let num = 1; num <= denom; num++){
    ...
    #generateMarkup() {
        // Safety check
        if (!this.#data || !this.#data.ingredients) return '<p>No recipe data available</p>';
        return `
